...
function Profile() {
    ...
    return (
      <div className="userDashboard">
        <p>
          ...
          {(error || plansError)?.message || "Unknown error"}
        </p>
      </div>
    );
  }
  ...
  const firstActivePlan =
    activePlans && activePlans.length > 0 ? activePlans[0] : null;
    ...
    <div className="userDashboard">
      ...
      <div className="active">
        ...
        {firstActivePlan ? (
          ...
          <p className="no-plans-message">No Active Plan Yet</p>
        )}
      </div>
      ...
      <div className="inactive">
        ...
        {inactivePlans.length === 0 ? (
          <p className="no-plans-message">No Inactive Plans Yet</p>
        ) : (
